...
<div class="wrapper row2">
 ...
 <div class="row row2">
              <?php
              $key = $select->productViewjoinpagination($start_form,$per_page);
              foreach ($key as $value) {
...
$getCourse = $select->productViewjoin();
...
?>
        ...
        <ul>
          <?php echo "<li><a href='farmermarket.php?page=1'>".'&laquo;'."Previous</a></li>"; 
            for ($i=1; $i <= $total_page; $i++) { 
                echo "<li><a href='farmermarket.php?page=".$i."'>".$i."</a>";
            }; ?>
         
       <?php echo "<li><a href='farmermarket.php?page=1'>".'&raquo;'."Next</a></li>"; ?>
